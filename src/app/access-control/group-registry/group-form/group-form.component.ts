  ...
  editGroup(group: Group) {
    ...
    this.groupDataService.patch(group, operations).pipe(
      ...
      if (rd.hasSucceeded) {
        ...
        this.notificationsService.error(this.translateService.get(this.messagePrefix + '.notification.edited.failure', { name: this.localeService.getStringByLocale(this.dsoNameService.getName(rd.payload)) }));
        this.cancelForm.emit();
      }
    });
  }
