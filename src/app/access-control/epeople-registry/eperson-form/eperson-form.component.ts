...
export class EPersonFormComponent implements OnInit, OnDestroy {
  ...
  university:DynamicSelectModel<string>;
  language:DynamicSelectModel<string>;
  college: DynamicInputModel;
  department: DynamicInputModel;
  role: DynamicInputModel;
  // booleans
...
},
{
  ...
  initialisePage() {
    ...
    observableCombineLatest([
      ...
      this.translateService.get(`${this.messagePrefix}.university`),
      this.translateService.get(`${this.messagePrefix}.college`),
      this.translateService.get(`${this.messagePrefix}.department`),
      this.translateService.get(`${this.messagePrefix}.role`),
      this.translateService.get(`${this.messagePrefix}.language`),
      this.translateService.get(`${this.messagePrefix}.canLogIn`),
      this.translateService.get(`${this.messagePrefix}.requireCertificate`),
      this.translateService.get(`${this.messagePrefix}.emailHint`),
    ]).subscribe(([firstName, lastName, email,university,college,department,role,language,canLogIn, requireCertificate, emailHint]) => {
      ...
      this.university = new DynamicSelectModel({
        id: 'university',
        label: university,
        name: 'university',
        options:this.universties.map((university) => Object.assign({ value: university.value, label:this.localeService.getStringByLocale(university.label)  })),
        value:this.epersonInitial.firstMetadataValue('eperson.university'),
        validators: {
          required: null,
        },
        required: true,
      });
      this.college = new DynamicInputModel({
        id: 'college',
        label: college,
        name: 'college',
    
      });
      this.department = new DynamicInputModel({
        id: 'department',
        label: department,
        name: 'department',
    
      });
      this.role = new DynamicInputModel({
        id: 'role',
        label: role,
        name: 'role',
    
      });
      this.language = new DynamicSelectModel({
        id: 'language',
        label: language,
        name: 'language',
        options:this.activeLangs.map((langConfig) => Object.assign({ value: langConfig.code, label: langConfig.label })),
        value:this.epersonInitial.firstMetadataValue('eperson.language'),
      ...
      this.subs.push(this.epersonService.getActiveEPerson().subscribe((eperson: EPerson) => {
        ...
        this.formGroup.patchValue({
          ...
          university:eperson != null ? eperson.firstMetadataValue('eperson.university') : '', 
          college:eperson != null ? eperson.firstMetadataValue('eperson.college') : '',
          department:eperson != null ? eperson.firstMetadataValue('eperson.department') : '',
          role:eperson != null ? eperson.firstMetadataValue('eperson.role') : '',
          language:eperson != null ? eperson.firstMetadataValue('eperson.language') : '',     
  ...
  editEPerson(ePerson: EPerson, values) {
    const editedEperson = Object.assign(new EPerson(), {
      ...
      metadata: {
        ...
        'eperson.university': [
          {
            value: (this.university.value ? this.university.value : ePerson.firstMetadataValue('eperson.university'))
          },
        ],
        'eperson.college': [
          {
            value: (this.college.value ? this.college.value : ePerson.firstMetadataValue('eperson.college'))
          },
        ],
        'eperson.department': [
          {
            value: (this.department.value ? this.department.value : ePerson.firstMetadataValue('eperson.department'))
          },
        ],
        'eperson.role': [
          {
            value: (this.role.value ? this.role.value : ePerson.firstMetadataValue('eperson.role'))
          },
        ],
        'eperson.language': [
          {
            value: (this.language.value ? this.language.value : ePerson.firstMetadataValue('eperson.language'))
          },
        ],
      },
