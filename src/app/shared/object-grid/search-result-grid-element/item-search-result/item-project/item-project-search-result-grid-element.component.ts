...
@Component({
  selector: 'ds-item-project-search-result-grid-element',
  styleUrls: ['./item-project-search-result-grid-element.component.scss'],
  templateUrl: './item-project-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemProjectSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
