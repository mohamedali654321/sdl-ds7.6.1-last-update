...
@Component({
  selector: 'ds-item-era-search-result-grid-element',
  styleUrls: ['./item-era-search-result-grid-element.component.scss'],
  templateUrl: './item-era-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemEraSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
