...
@Component({
  selector: 'ds-item-series-search-result-grid-element',
  styleUrls: ['./item-series-search-result-grid-element.component.scss'],
  templateUrl: './item-series-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemSeriesSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
