...
@Component({
  selector: 'ds-item-org-unit-search-result-grid-element',
  styleUrls: ['./item-org-unit-search-result-grid-element.component.scss'],
  templateUrl: './item-org-unit-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemOrgUnitSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
