...
@Component({
  selector: 'ds-item-journal-issue-search-result-grid-element',
  styleUrls: ['./item-journal-issue-search-result-grid-element.component.scss'],
  templateUrl: './item-journal-issue-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemJournalIssueSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
