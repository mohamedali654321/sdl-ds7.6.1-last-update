...
@Component({
  selector: 'ds-item-event-search-result-grid-element',
  styleUrls: ['./item-event-search-result-grid-element.component.scss'],
  templateUrl: './item-event-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemEventSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
