...
@Component({
  selector: 'ds-item-person-search-result-grid-element',
  styleUrls: ['./item-person-search-result-grid-element.component.scss'],
  templateUrl: './item-person-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemPersonSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
