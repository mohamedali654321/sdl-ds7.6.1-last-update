...
@Component({
  selector: 'ds-item-activity-search-result-grid-element',
  styleUrls: ['./item-activity-search-result-grid-element.component.scss'],
  templateUrl: './item-activity-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemActivitySearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
