...
@Component({
  selector: 'ds-item-sub-org-unit-search-result-grid-element',
  styleUrls: ['./item-sub-org-unit-search-result-grid-element.component.scss'],
  templateUrl: './item-sub-org-unit-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemSubOrgUnitSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
