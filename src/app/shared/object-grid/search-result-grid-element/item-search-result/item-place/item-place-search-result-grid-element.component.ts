...
@Component({
  selector: 'ds-item-place-search-result-grid-element',
  styleUrls: ['./item-place-search-result-grid-element.component.scss'],
  templateUrl: './item-place-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemPlaceSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
