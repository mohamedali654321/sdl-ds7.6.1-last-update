...
@Component({
  selector: 'ds-item-site-search-result-grid-element',
  styleUrls: ['./item-site-search-result-grid-element.component.scss'],
  templateUrl: './item-site-search-result-grid-element.component.html',
  animations: [focusShadow]
})
/**
 * The component for displaying a grid element for an item search result of the type Organisation Unit
 */
export class ItemSiteSearchResultGridElementComponent extends  SearchResultGridElementComponent<ItemSearchResult, Item> {
  /**
