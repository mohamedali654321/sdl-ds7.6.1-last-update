...
@listableObjectComponent('EraSearchResult', ViewMode.ListElement)
// @listableObjectComponent(ItemSearchResult, ViewMode.ListElement)
@Component({
  selector: 'ds-item-era-search-result-list-element',
  styleUrls: ['./item-era-search-result-list-element.component.scss'],
  templateUrl: './item-era-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class EraSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
