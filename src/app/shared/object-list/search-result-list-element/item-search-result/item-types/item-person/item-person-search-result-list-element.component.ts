...
@Component({
  selector: 'ds-item-person-search-result-list-element',
  styleUrls: ['./item-person-search-result-list-element.component.scss'],
  templateUrl: './item-person-search-result-list-element.component.html'
})
/**
