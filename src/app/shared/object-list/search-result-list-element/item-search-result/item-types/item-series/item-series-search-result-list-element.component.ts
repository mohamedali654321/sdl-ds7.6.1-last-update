...
@Component({
  selector: 'ds-item-series-search-result-list-element',
  styleUrls: ['./item-series-search-result-list-element.component.scss'],
  templateUrl: './item-series-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class SeriesSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
