...
@Component({
  selector: 'ds-item-org-unit-search-result-list-element',
  styleUrls: ['./item-org-unit-search-result-list-element.component.scss'],
  templateUrl: './item-org-unit-search-result-list-element.component.html'
})
/**
