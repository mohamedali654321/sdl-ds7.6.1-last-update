...
@Component({
  selector: 'ds-item-journal-volume-search-result-list-element',
  styleUrls: ['./item-journal-volume-search-result-list-element.component.scss'],
  templateUrl: './item-journal-volume-search-result-list-element.component.html'
})
/**
