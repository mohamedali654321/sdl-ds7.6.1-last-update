...
@Component({
  selector: 'ds-item-place-search-result-list-element',
  styleUrls: ['./item-place-search-result-list-element.component.scss'],
  templateUrl: './item-place-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class PlaceSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
