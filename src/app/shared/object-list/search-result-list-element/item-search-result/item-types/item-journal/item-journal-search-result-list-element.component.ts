...
@Component({
  selector: 'ds-item-journal-search-result-list-element',
  styleUrls: ['./item-journal-search-result-list-element.component.scss'],
  templateUrl: './item-journal-search-result-list-element.component.html'
})
/**
