...
@Component({
  selector: 'ds-item-sub-org-unit-search-result-list-element',
  styleUrls: ['./item-sub-org-unit-search-result-list-element.component.scss'],
  templateUrl: './item-sub-org-unit-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class SubOrgUnitSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
