...
@Component({
  selector: 'ds-item-activity-search-result-list-element',
  styleUrls: ['./item-activity-search-result-list-element.component.scss'],
  templateUrl: './item-activity-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class ActivitySearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
