...
@Component({
  selector: 'ds-item-project-search-result-list-element',
  styleUrls: ['./item-project-search-result-list-element.component.scss'],
  templateUrl: './item-project-search-result-list-element.component.html'
})
/**
