...
@Component({
  selector: 'ds-item-journal-issue-search-result-list-element',
  styleUrls: ['./item-journal-issue-search-result-list-element.component.scss'],
  templateUrl: './item-journal-issue-search-result-list-element.component.html'
})
/**
