...
@Component({
  selector: 'ds-item-site-search-result-list-element',
  styleUrls: ['./item-site-search-result-list-element.component.scss'],
  templateUrl: './item-site-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class SiteSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
